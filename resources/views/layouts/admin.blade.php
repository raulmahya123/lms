  ...
  <aside class="fixed inset-y-0 left-0 w-64 transform lg:transform-none lg:static z-40 transition-transform duration-300"
    ...
    <div class="p-4 flex items-center justify-between">
      ...
      <button class="p-2 rounded lg:hidden focus:outline-none focus:ring-2 focus:ring-offset-2"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 6l12 12M18 6L6 18"/></svg>
      </button>
    </div>
    ...
    <nav class="px-3 space-y-1" aria-label="Primary">
      @php
        ...
        $icon = function($label) {
          ...
          return match($label) {
            'Dashboard'   => "<svg $base><path d='M3 13h8V3H3v10zM13 21h8V11h-8v10z'/></svg>",
            'Courses'     => "<svg $base><path d='M4 19l8 3 8-3V5l-8-3-8 3v14z'/><path d='M12 22V8'/></svg>",
            'Modules'     => "<svg $base><rect x='3' y='3' width='7' height='7'/><rect x='14' y='3' width='7' height='7'/><rect x='3' y='14' width='7' height='7'/><rect x='14' y='14' width='7' height='7'/></svg>",
            'Lessons'     => "<svg $base><path d='M4 19.5V5a2 2 0 0 1 2-2h9l5 5v11.5a2.5 2.5 0 0 1-2.5 2.5H6.5A2.5 2.5 0 0 1 4 19.5z'/><path d='M14 3v5h5'/></svg>",
            'Quizzes'     => "<svg $base><path d='M9 9h6'/><path d='M9 13h6'/><path d='M5 7l-2 2 2 2'/><path d='M19 15l2 2-2 2'/><rect x='3' y='3' width='18' height='18' rx='2'/></svg>",
            'Questions'   => "<svg $base><path d='M9 9a3 3 0 1 1 6 0c0 2-3 2-3 4'/><path d='M12 17h.01'/><rect x='3' y='3' width='18' height='18' rx='2'/></svg>",
            'Options'     => "<svg $base><circle cx='12' cy='12' r='3'/><path d='M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V22a2 2 0 1 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 5 15.4a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06A2 2 0 1 1 7.04 4.3l.06.06c.47.47 1.13.68 1.82.33A1.65 1.65 0 0 0 10 3.09V3a2 2 0 1 1 4 0v.09c0 .66.39 1.26 1 1.51.69.35 1.35.14 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06c-.47.47-.68 1.13-.33 1.82.35.69 1.15 1 1.51 1H22a2 2 0 1 1 0 4h-.09c-.66 0-1.26.39-1.51 1z'/></svg>",
            'Memberships' => "<svg $base><path d='M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2'/><circle cx='12' cy='7' r='4'/></svg>",
            'Enrollments' => "<svg $base><path d='M4 4h16v12H4z'/><path d='M8 20h8M12 16v4'/></svg>",
            'Payments'    => "<svg $base><rect x='2' y='5' width='20' height='14' rx='2'/><path d='M2 10h20'/></svg>",
    ...
    <header class="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 shadow sticky top-0 z-30"
      ...
      <div class="flex items-center gap-2">
        <button class="p-2 rounded lg:hidden focus:outline-none focus:ring-2 focus:ring-offset-2"
          ...
          <svg viewBox="0 0 24 24" class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M3 12h18M3 18h18"/></svg>
        </button>
      ...
      <div class="flex items-center gap-2 sm:gap-3" x-data="{open:false}">
        ...
        <div class="relative">
          <button @click="open=!open" @keydown.escape.window="open=false"
            ...
            <svg viewBox="0 0 24 24" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg>
          </button>
