...
<style>
  ...
  .logo-chip{
    ...
    filter: grayscale(1) opacity(.85); transition: all .2s ease;
  }
  ...
  .card-locked::after{
    content:""; position:absolute; inset:0; background:rgba(2,6,23,.45);
  ...
  .lock-badge{
    ...
    background:rgba(15,23,42,.75); color:#fff; font-size:.72rem; font-weight:600;
    z-index:2;
  }
  ...
  .divider{
    height:3px; width:68px; border-radius:999px;
  ...
  .course-pill{
    ...
    padding:.35rem .55rem; border-radius:999px; font-size:.7rem; font-weight:700;
    background:#fff; color:#0f172a; border:1px solid rgba(2,6,23,.08); box-shadow:0 6px 20px rgba(2,6,23,.08);
  }
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        @forelse ($latestCourses as $course)
          ...
          <a href="{{ $courseUrl }}"
             class="group course-card overflow-hidden hover-lift block h-full flex flex-col">
            <div class="thumb">
              @if($pp > 0)
      ...
      <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse ($popularCourses as $course)
          ...
          <a href="{{ auth()->check() ? route('app.courses.show', $course) : route('register') }}"
             class="group card card-lg overflow-hidden hover-lift transition block">
