...
@section('title', 'Tambah Resource — Admin')
...
<div class="max-w-3xl mx-auto space-y-8 pb-12">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      ...
      <h1 class="text-3xl font-extrabold text-text-main tracking-tight">Tambah Resource</h1>
      <p class="text-sm text-text-soft mt-1">Lampirkan file PDF, link video, atau referensi lain ke pelajaran.</p>
    </div>
  ...
  <form method="POST" action="{{ route('admin.resources.store') }}" class="bg-white rounded-3xl border border-gray-50 shadow-[0_4px_24px_rgba(0,0,0,0.02)] overflow-hidden">
    @csrf
