        ...
        <tbody class="[&>tr:hover]:bg-gray-50">
          @forelse($courses as $c)
            <tr class="border-t align-top">
              ...
              <td class="p-3">
                @php $cover = $c->cover_url_resolved ?? null; @endphp
                @if($cover)
                  <img src="{{ $cover }}" alt="Cover {{ $c->title }}" class="h-12 w-20 object-cover rounded border">
                @else
                  <div class="h-12 w-20 grid place-items-center border rounded text-xs text-gray-500">No image</div>
                @endif
              </td>
              ...
              <td class="p-3">
                ...
                @else
                  <span class="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800">
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M4.5 6.75A2.25 2.25 0 0 1 6.75 4.5h10.5A2.25 2.25 0 0 1 19.5 6.75V15a.75.75 0 0 1-.22.53l-4.5 4.5a.75.75 0 0 1-1.28-.53V15.75H6.75A2.25 2.25 0 0 1 4.5 13.5v-6.75Z"/></svg>
                    Draft
                  </span>
                @endif
              </td>
