...
@section('title', 'Tambah Pendaftaran — Admin')
...
<div class="max-w-5xl mx-auto pb-12 space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <h1 class="text-3xl font-extrabold text-text-main tracking-tight">Tambah Pendaftaran</h1>
            <p class="text-sm text-text-soft mt-1">Daftarkan pengguna secara manual ke dalam course atau kelas.</p>
        </div>
    ...
    {{-- FORM --}}
    <form id="enrollmentForm" method="POST" action="{{ route('admin.enrollments.store') }}">
        @csrf
