...
<div class="max-w-5xl mx-auto p-6 space-y-6">
  ...
  <div class="flex items-center justify-between">
    <h1 class="text-xl font-semibold text-[#1D1C1A]">Edit Enrollment #{{ $enrollment->id }}</h1>
  ...
  {{-- FORM --}}
  <form id="enrollmentForm" method="POST" action="{{ route('admin.enrollments.update', $enrollment) }}" class="bg-white border rounded-2xl p-6 space-y-6">
    @csrf
    @method('PUT')
