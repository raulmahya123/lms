...
@section('title','Edit Tes Psikologi — Admin')
...
<div class="max-w-3xl mx-auto space-y-8 pb-12">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      ...
      <h1 class="text-3xl font-extrabold text-text-main tracking-tight">Edit Tes Psikologi</h1>
      <p class="text-sm text-text-soft mt-1">Ubah konfigurasi dan informasi tes psikologi yang sudah ada.</p>
    </div>
    <div class="shrink-0 flex gap-3">
      <a href="{{ route('admin.psy-tests.show', $psy_test) }}" class="inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-colors">
  ...
  <form method="POST" action="{{ route('admin.psy-tests.update', $psy_test) }}" class="bg-white rounded-3xl border border-gray-50 shadow-[0_4px_24px_rgba(0,0,0,0.02)] overflow-hidden">
    @csrf @method('PUT')
    ...
    <div class="p-8 space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" name="name" value="{{ old('name', $psy_test->name) }}" 
          ...
          <div>
            <label class="block text-sm font-bold text-text-main mb-2">Slug</label>
            <input type="text" name="slug" value="{{ old('slug', $psy_test->slug) }}" 
                   ...
                   placeholder="(Kosongkan untuk generate dari nama)">
      ...
      <div>
        ...
        <div class="relative w-full md:w-1/2">
            ...
            <input type="number" name="time_limit_min" value="{{ old('time_limit_min', $psy_test->time_limit_min) }}" min="1" max="600"
      ...
      <div class="pt-4 border-t border-gray-100">
        <label class="flex items-center gap-3 cursor-pointer group w-max">
          ...
          <div class="relative">
            <input type="checkbox" name="is_active" value="1" class="peer sr-only" @checked(old('is_active', (int)$psy_test->is_active) == 1)>
    ...
    <div class="p-6 border-t border-gray-50 bg-gray-50/30 flex flex-col-reverse sm:flex-row items-center justify-end gap-3">
      <a href="{{ route('admin.psy-tests.show', $psy_test) }}" class="w-full sm:w-auto px-6 py-3 rounded-xl bg-white border border-gray-200 text-gray-700 font-bold hover:bg-gray-50 transition-colors text-center">
        Batal
      </a>
