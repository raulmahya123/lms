...
<div class="max-w-5xl mx-auto p-6 space-y-6">
  ...
  <div class="flex items-center justify-between">
    <h1 class="text-xl font-semibold text-[#1D1C1A]">Edit Membership #{{ $membership->id }}</h1>
  ...
  {{-- FORM --}}
  <form id="membershipForm" method="POST" action="{{ route('admin.memberships.update', $membership) }}" class="bg-white border rounded-2xl p-6 space-y-6">
    @csrf
    @method('PUT')
