            ...
            <tr class="border-t align-top">
              ...
              <td class="p-3">
                ...
                @if(!empty($t->description))
                  <div class="text-xs text-gray-600 max-w-lg">{{ Str::limit(strip_tags($t->description), 120) }}</div>
                @endif
              </td>
              ...
              <td class="p-3">
                ...
                @if($bg)
                  <a href="{{ $bg }}" target="_blank" class="inline-flex items-center gap-2 text-blue-600 hover:underline">
                    {{-- image icon --}}
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M4.5 5.75A2.75 2.75 0 0 1 7.25 3h9.5A2.75 2.75 0 0 1 19.5 5.75v12.5A2.75 2.75 0 0 1 16.75 21h-9.5A2.75 2.75 0 0 1 4.5 18.25V5.75Zm3 2a1.25 1.25 0 1 0 0 2.5A1.25 1.25 0 0 0 7.5 7.75Z"/></svg>
                    Preview
                  </a>
                @else
              ...
              <td class="p-3 text-center">
                <div class="flex items-center justify-center gap-2">
                  ...
                  <form method="POST" action="{{ route('admin.certificate-templates.destroy',$t) }}"
                        onsubmit="return confirm('Delete template?')" class="inline">
                    @csrf @method('DELETE')
            ...
            <tr>
              <td colspan="5" class="p-10">
                <div class="flex flex-col items-center justify-center text-center gap-3">
                  ...
                  <p class="text-sm opacity-70 max-w-md">Buat template pertama untuk mulai menerbitkan sertifikat.</p>
                  <a href="{{ route('admin.certificate-templates.create') }}"
