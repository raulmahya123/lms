...
@section('content')
@php
  // Ambil daftar nilai filter dinamis (aman dipakai seperti di halaman Modules)
  $testId = request('psy_test_id');
  $q      = request('q');
  $qtype  = request('qtype');
  $trait  = request('trait');

  // Source dropdown (opsional dari DB biar lengkap)
            ...
            <tr class="border-t align-top">
              ...
              <td class="p-3 text-center">
                <div class="flex items-center justify-center gap-2">
                  ...
                  <form method="POST" action="{{ route('admin.questions.destroy',$item) }}"
